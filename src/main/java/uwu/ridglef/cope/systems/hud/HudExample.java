package uwu.ridglef.cope.systems.hud;
...
public class HudExample extends HudElement {
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(RidglefAddon.HUD_GROUP, "example", "HUD element example.", HudExample::new);
